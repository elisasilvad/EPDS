...
// Add line bullets
    ...
    var greenville = addCity({ "latitude": 34.85262, "longitude": -82.39401 }, "Greenville");
...
// Add lines
    ...
    addLine(paris, minneapolis);
    addLine(minneapolis, new_york);
    addLine(new_york, greenville);
    addLine(greenville, new_york);
